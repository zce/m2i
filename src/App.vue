<template>
  ...
  <section class="flex flex-col flex-1 m-2">
    ...
    <div class="flex pb-3">
      ...
      <button :disabled="loading || !markdown" @click="generate" class="flex items-center ml-2 py-2 px-4 border border-transparent font-medium rounded text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
...
const width = ref(600)
const scale = ref(2)
const template = ref(`<link rel="stylesheet" href="https://cdn.zce.me/markdown.css">
{{markdown}}`)
